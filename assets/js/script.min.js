window.innerWidth < 768 && [].slice.call(document.querySelectorAll("[data-bss-disabled-mobile]")).forEach((function (e) {
        ...
        function d(e) {
            ...
            if (e.parents(".cd-headline").hasClass("type")) {
                ...
                r(e.find("i").eq(0), e, a, 50), l(s.find("i").eq(0), s, a, 50)
        ...
        function o(e, s) {
            e.parents(".cd-headline").hasClass("type") ? (l(e.find("i").eq(0), e, !1, s), e.addClass("is-visible").removeClass("is-hidden")) : e.parents(".cd-headline").hasClass("clip") && e.parents(".cd-words-wrapper").animate({
                width: e.width() + 10
            }, 600, (function () {
                setTimeout((function () {
                    d(e)
        ...
        function r(s, i, a, n) {
            if (s.removeClass("in").addClass("out"), s.is(":last-child") ? a && setTimeout((function () {
                    d(c(i))
                }), t) : setTimeout((function () {
                    r(s.next(), i, a, n)
                }), n), s.is(":last-child") && e("html").hasClass("no-csstransitions")) {
                var o = c(i);
                u(i, o)
            }
        }
        ...
        e(".cd-headline.letters").find("b").each((function () {
            ...
            for (i in a) s.parents(".rotate-2").length > 0 && (a[i] = "<em>" + a[i] + "</em>"), a[i] = t ? '<i class="in">' + a[i] + "</i>" : "<i>" + a[i] + "</i>";
            var n = a.join("");
            s.html(n).css("opacity", 1)
        })), s = e(".cd-headline"), a = t, s.each((function () {
            var s = e(this);
            if (s.hasClass("loading-bar")) a = n, setTimeout((function () {
                ...
                var o = s.find(".cd-words-wrapper b"),
                    r = 0;
                o.each((function () {
                    var s = e(this).width();
                    s > r && (r = s)
    ...
    function () {
        ...
        if (e) {
            ...
            s(), document.addEventListener("scroll", s)
        }
    }();
AOS.init();